...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None, query_text: Optional[str] = None) -> Dict[str, str]:
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None, query_text: Optional[str] = None) -> str:
    ...
    warm across turns.
    """
    parts = build_system_prompt_parts(agent, system_message=system_message, query_text=query_text)
